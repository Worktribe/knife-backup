...
This Knife plugin has been forked at Worktribe in order to fix bugs relating to import/export of node attribute data. To use it, run `gem install wt-knife-backup`. The Gem is hosted at https://rubygems.org/gems/wt-knife-backup.
